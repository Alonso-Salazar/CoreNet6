...
public partial class AdventureWorks2019Context : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Permiso>(entity =>
        {
            ...
            entity.HasMany(d => d.BusinessEntities).WithMany(p => p.Permisos)
                .UsingEntity<Dictionary<string, object>>(
                    "PermisoByPerson",
                    r => r.HasOne<Person>().WithMany()
                        .HasForeignKey("BusinessEntityId")
                        .OnDelete(DeleteBehavior.ClientSetNull)
                        .HasConstraintName("FK_PermisoByPerson_Person"),
                    l => l.HasOne<Permiso>().WithMany()
                        .HasForeignKey("PermisoId")
                        .OnDelete(DeleteBehavior.ClientSetNull)
                        .HasConstraintName("FK_PermisoByPerson_Permiso"),
                    j =>
                    {
                        j.HasKey("PermisoId", "BusinessEntityId");
                        j.ToTable("PermisoByPerson", "Person");
